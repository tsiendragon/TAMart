...
import type { TamManifest } from './schema.js'

export function loadManifest(pkgDir: string): { manifest: TamManifest; manifestPath: string } {
  ...
  return { manifest: raw as TamManifest, manifestPath }
}
